...
# Predicted closing price adjustment: Align with the opening price
last_60_predicted[:, 1] = last_60_predicted[:, 0] * 0.99  # Adjust close to be close to open
...
# MAE, MSE, and R² Calculation for Open
...
# Align predicted closing price with the opening price
predicted_close_price = predicted_open_price * 0.99  # Adjust close to be close to open
